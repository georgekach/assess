  ...
  describe('Announcements Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      beforeEach(function () {
        ...
        sampleAnnouncementPostData = new AnnouncementsService({
          name: 'Announcement Name'
        });

        $scope.vm.announcement = sampleAnnouncementPostData;
      });

      it('should send a POST request with the form input values and then locate to new object URL', inject(function (AnnouncementsService) {
        // Set POST response
        ...
        expect($state.go).toHaveBeenCalledWith('announcements.view', {
          announcementId: mockAnnouncement._id
        });
      }));
    ...
    describe('vm.save() as update', function () {
      beforeEach(function () {
        ...
        $scope.vm.announcement = mockAnnouncement;
      });

      it('should update a valid Announcement', inject(function (AnnouncementsService) {
        // Set PUT response
      ...
      it('should set $scope.vm.error if error', inject(function (AnnouncementsService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the Announcement and redirect to Announcements', function () {
        ...
        expect($state.go).toHaveBeenCalledWith('announcements.list');
      });

      it('should should not delete the Announcement and not redirect', function () {
