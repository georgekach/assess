  ...
  describe('Teachers Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      beforeEach(function () {
        ...
        sampleTeacherPostData = new TeachersService({
          name: 'Teacher Name'
        });

        $scope.vm.teacher = sampleTeacherPostData;
      });

      it('should send a POST request with the form input values and then locate to new object URL', inject(function (TeachersService) {
        // Set POST response
        ...
        expect($state.go).toHaveBeenCalledWith('teachers.view', {
    ...
    describe('vm.save() as update', function () {
      beforeEach(function () {
        ...
        $scope.vm.teacher = mockTeacher;
      });

      it('should update a valid Teacher', inject(function (TeachersService) {
        // Set PUT response
      ...
      it('should set $scope.vm.error if error', inject(function (TeachersService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the Teacher and redirect to Teachers', function () {
        ...
        expect($state.go).toHaveBeenCalledWith('teachers.list');
      });

      it('should should not delete the Teacher and not redirect', function () {
